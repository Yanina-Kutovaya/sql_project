Oбщее текстовое описание базы данных и решаемых ею задач.
...
- Страна с самой большой выручкой от проживания туристов за прошедшую неделю 
- Доля сетевых компаний на туристическом рынке, лидер продаж каждой сети, доля лидера в продажах каждой сети (по данным о выручке от       проживания туристов за последнюю неделю)
